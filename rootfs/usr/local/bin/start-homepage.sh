...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202211201319-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  WTFPL
# @@ReadME           :  start-homepage.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Nov 20, 2022 13:19 EST
# @@File             :  start-homepage.sh
# @@Description      :  script to start homepage
...
__heath_check() {
  ...
  #__pgrep ${1:-homepage} &>/dev/null || healthStatus=$((healthStatus + 1))
...
HOSTNAME="${HOSTNAME:-casjaysdev-homepage}"
...
SERVICE_COMMAND="$SERVICE_NAME server.js"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
