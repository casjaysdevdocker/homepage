...
```shell
dockermgr download src homepage
```

OR

```shell
git clone "https://github.com/casjaysdevdocker/homepage" "$HOME/Projects/github/casjaysdevdocker/homepage"
```

## Build container  

```shell
cd "$HOME/Projects/github/casjaysdevdocker/homepage"
buildx 
```
